...
export const imports: ImportDataMap = {
  "fflate.umd.js@1.0.0": {
    data: libData["fflate.umd.js@1.0.0"],
    wrapper: "b64-js-wrap@1.0.0",
    pages: calcStoragePages(libData["fflate.umd.js@1.0.0"]),
  },
  "htm-preact.module.js@3.1.1": {
    data: libData["htm-preact.module.js@3.1.1"],
    wrapper: "b64-gz-importmap-js-wrap@1.0.0",
    pages: calcStoragePages(libData["htm-preact.module.js@3.1.1"]),
  },
  "tone.module.js@14.7.77": {
    data: libData["tone.module.js@14.7.77"],
    wrapper: "b64-gz-importmap-js-wrap@1.0.0",
    pages: calcStoragePages(libData["tone.module.js@14.7.77"]),
  },
  "three.module.js@0.144.0": {
    data: libData["three.module.js@0.144.0"],
    wrapper: "b64-gz-importmap-js-wrap@1.0.0",
    pages: calcStoragePages(libData["three.module.js@0.144.0"]),
  },
  "p5.module.js@1.4.2": {
    data: libData["p5.module.js@1.4.2"],
    wrapper: "b64-gz-importmap-js-wrap@1.0.0",
    pages: calcStoragePages(libData["p5.module.js@1.4.2"]),
  },
};
...
export const deployDefaults = async () => {
  ...
  await deployNewFrame(
    [
      ...
      // [imports["tone@14.7.77"].wrapper, "tone@14.7.77"],
      // [imports["p5@1.4.2"].wrapper, "p5@1.4.2"],
      [imports["three@0.144.0"].wrapper, "three@0.144.0"],
    ],
    [
      [
        "js-module-wrap@1.0.0",
    ...
    constructRenderIndex(
      [
        ...
        // imports["tone@14.7.77"].pages,
        // imports["p5@1.4.2"].pages,
        imports["three@0.144.0"].pages,
        1,
      ],
      RENDER_PAGE_SIZE
    )
